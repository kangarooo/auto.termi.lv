...
// Load this file's selection again by visiting: http://mootools.net/more/4d15ffaea878ff0996b8152edf68e6ea
// Or build this file again with packager using: packager build More/Date.Extras More/Number.Format More/String.Extras More/URI More/Fx.Reveal More/Slider More/Request.Queue More/Locale
/*
---
copyrights:
...
var a=this.get("reveal").setOptions(b.options);a.reveal().chain(function(){(function(){a.dissolve();}).delay(b.duration||2000);});}});Class.Mutators.Binds=function(a){return a;
